...
INSERT INTO `store` (`SID`, `SPASS`, `SBRANCHNAME`, `SCITY`, `SSTATE`, `SCOUNTRY`, `SPCODE`) VALUES
(100, 'admin', 'Kishore', 'zhb', 'south', 'Tela', 222),
(101, 'admin', 'Silk Point', 'Bidar', 'Karnataka', 'India', 585401);
